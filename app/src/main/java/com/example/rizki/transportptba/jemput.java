...
public class jemput {
    ...
    public jemput(String emailp, String nohp, String satker, String tanggal, String waktu, String jmlpenumpang, String keperluan, String ket,String ke, Boolean ambil) {
        this.emailp = emailp;
        this.nohp = nohp;
        this.satker = satker;
